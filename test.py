...
recommendations = {
    "로맨스 ❤️": {
        "책": [
            ...
            {"제목": "러브 레터", "줄거리": "가슴 아픈 사랑의 기억을 담은 일본 소설."},
            {"제목": "연애의 발견", "줄거리": "과거와 현재의 사랑을 유쾌하게 풀어낸 작품."}
        ],
        "영화": [
            ...
            {"제목": "이터널 선샤인", "줄거리": "기억을 지워도 남는 사랑의 흔적."}
        ]
    },
    "판타지 🧙": {
        "책": [
            ...
            {"제목": "호빗", "줄거리": "작은 호빗의 위대한 모험과 용과의 대결."},
            {"제목": "네버엔딩 스토리", "줄거리": "상상력이 현실이 되는 판타지 세계의 모험."}
        ],
        "영화": [
            ...
            {"제목": "반지의 제왕", "줄거리": "절대 반지를 둘러싼 선과 악의 전쟁."},
            {"제목": "해리 포터와 마법사의 돌", "줄거리": "마법 학교에 입학한 소년의 첫 모험."}
        ]
    },
    "스릴러 🔪": {
        "책": [
            ...
            {"제목": "아메리칸 사이코", "줄거리": "양면적인 삶을 사는 뉴욕 월스트리트 남자의 충격적 이야기."},
            {"제목": "사일런트 페이션트", "줄거리": "살인 후 말을 잃은 여자의 비밀을 파헤치는 이야기."},
            {"제목": "종이 여자", "줄거리": "기묘한 관계 속에서 드러나는 스릴러적 반전."}
        ],
        "영화": [
            ...
            {"제목": "올드보이", "줄거리": "복수와 비밀이 얽힌 충격적인 스릴러."},
            {"제목": "셔터 아일랜드", "줄거리": "정신병원에 숨겨진 음모와 미스터리."}
        ]
    },
    "SF 🚀": {
        "책": [
            ...
            {"제목": "안드로이드는 전기양을 꿈꾸는가?", "줄거리": "인간과 인조인간의 경계에 대한 탐구."},
            {"제목": "콘택트", "줄거리": "외계와의 접촉을 다룬 과학적 SF 소설."}
        ],
        "영화": [
            {"제목": "듄", "줄거리": "사막 행성을 둘러싼 권력과 생존의 이야기."},
            {"제목": "테넷", "줄거리": "시간을 거꾸로 흐르게 하는 비밀 작전."},
            {"제목": "에브리씽 에브리웨어 올 앳 원스", "줄거리": "멀티버스 속의 평범한 주인공이 펼치는 독창적 SF 모험."},
            {"제목": "매트릭스", "줄거리": "가상현실 세계의 혁명적 이야기."},
            {"제목": "인터스텔라", "줄거리": "시간과 공간을 초월한 가족과 생존의 이야기."},
            {"제목": "인셉션", "줄거리": "꿈속에서 벌어지는 다층적인 잠입 작전."}
        ]
    }
}
        ...
        with cols[idx]:
            st.markdown(
                ...
                box-shadow:2px 2px 8px rgba(0,0,0,0.1); margin-bottom:15px;">
                    <h4 style="color:#2C3E50; text-align:center;">📖 {choice['제목']}</h4>
                    <p style="font-size:14px; color:#555;">{choice['줄거리']}</p>
                </div>
                """,
