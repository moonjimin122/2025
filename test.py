...
recommendations = {
    "로맨스": {
        ...
        "영화": [
            ...
            {"제목": "비포 선라이즈", "줄거리": "기차에서 우연히 만난 두 사람이 하루 동안 사랑을 나누는 이야기.", "이미지": "https://upload.wikimedia.org/wikipedia/en/d/da/Before_Sunrise_poster.jpg"}
        ]
    },
    "판타지": {
        "책": [
        ...
        "영화": [
            ...
            {"제목": "판의 미로: 오필리아와 세 개의 열쇠", "줄거리": "스페인 내전 후 소녀가 환상 세계와 현실 사이를 넘나드는 이야기.", "이미지": "https://upload.wikimedia.org/wikipedia/en/6/6f/Pans_labyrinth.jpg"}
        ]
    },
    "스릴러": {
        "책": [
        ...
        "영화": [
            ...
            {"제목": "올드보이", "줄거리": "15년간 감금되었던 남자의 충격적 복수극.", "이미지": "https://upload.wikimedia.org/wikipedia/en/6/67/Oldboykoreanposter.jpg"}
        ]
    },
    "SF": {
        "책": [
        ...
        "영화": [
            ...
            {"제목": "블레이드 러너 2049", "줄거리": "인간과 인조인간의 경계와 존재의 의미를 탐구하는 미래 도시 이야기.", "이미지": "https://upload.wikimedia.org/wikipedia/en/2/27/Blade_Runner_2049_logo.png"}
        ]
    }
}
